...
class PawnSpec extends Specification{
  ...
  "A Pawn" should{
    val pawn = Option(Pawn(color = true,moved = false))
    val chessBoard = new ChessBoardFactory().create(3)
    val moveableFields: Vector[(Int,Int)] = Vector()
    chessBoard (0)(1) = pawn
    chessBoard(1)(1) = Option(Pawn(color = false,moved = false))
  ...
  "A Pawn" should{
    val pawn = Option(Pawn(color = false,moved = false))
    val chessBoard = new ChessBoardFactory().create(3)
    val moveableFields: Vector[(Int,Int)] = Vector()
    chessBoard (2)(1) = pawn
    chessBoard(1)(1) = Option(Pawn(color = false,moved = false))
  ...
  "A Pawn" should{
    ...
    chessBoard (2)(1) = pawn
    chessBoard(1)(0) = Option(Pawn(color = true,moved = false))
    chessBoard(1)(2) = Option(Pawn(color = true,moved = false))
  ...
  "A Pawn" should{
    ...
    var moveableFields: Vector[(Int,Int)] = Vector()
    chessBoard (0)(1) = pawn
    chessBoard (1)(0) = Option(Pawn(color = false,moved = false))
    chessBoard (1)(2) = Option(Pawn(color = true,moved = false))
